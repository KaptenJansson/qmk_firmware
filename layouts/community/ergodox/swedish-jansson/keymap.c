...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox(
    ...
    LT(SYMB, NO_APOS), NO_ACUT, KC_LGui, KC_LEFT, KC_RGHT,
 ...
 /* Keymap 3: Mac Symbol Layer
  ...
  [MAC] = LAYOUT_ergodox(
    // left hand
    NO_HALF, KC_F1,   KC_F2,   KC_F3,       KC_F4,       KC_F5,   KC_TRNS,
    KC_TRNS, KC_EXLM, NO_AT_MAC,   NO_LCBR_MAC, NO_RCBR_MAC, NO_PIPE_MAC, KC_PAST,
    KC_LCTL, KC_HASH, NO_DLR_MAC,  NO_LPRN,     NO_RPRN,     NO_GRV_MAC,
    KC_LSFT, KC_PERC, NO_CIRC, NO_LBRC,     NO_RBRC,     NO_TILD, OSL(2),
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,
                                                 KC_TRNS, KC_MPLY,
                                                          KC_MNXT,
                                        KC_FN8, KC_TRNS, KC_MPRV,
    // right hand
    KC_TRNS, KC_F6,   KC_F7,   KC_F8,  KC_F9, KC_F10,  KC_F11,
    KC_TRNS, KC_UP,   KC_7,    KC_8,   KC_9,  NO_ASTR, KC_F12,
             KC_DOWN, KC_4,    KC_5,   KC_6,  NO_PLUS, KC_TRNS,
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [2] = ACTION_LAYER_TAP_TOGGLE(MAC),  // FN3 - Momentary Layer 2 (Game)
};
